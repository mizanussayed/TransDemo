      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            ...
            <h2>To provide a sophisticated translation that keeps pace with the development taking place in the Kingdom
              and is in line with the Kingdom's future vision.</h2>
            <div class="text-center text-lg-start">
              <a href="contact" class="btn-get-started">Get A Quote Now</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="testimonials" id="testimonials">
      <div class="container">
        <div class="section-title" data-aos="fade-up">
          ...
          <p>We love partnering/ customers and growing ambitious and successful businesses as we are committed to provide a
    ...
    <section class="category" id="category">
      <div class="container">
        <div class="section-title" data-aos="fade-up">
          ...
          <p>Our Mission is Serving the Saudi business market through in a high quality and speed in performing work
            with professionalism and sincerity.</p>
        </div>
            ...
            <div class="row">
              <div class="py-2">
                ...
                <p>
                  ...
                  environment of mutual respect. This is the thinking behind our translation services where we have
                  developed this
                  concept since our office was founded and have been able to establish a highly productive and
                  consistent quality translation workflow.
                </p>
              </div>
              <div class="py-2">
                <h4> <img src="./assets/img/check-mark-1.svg" alt="lexicology Translation" />
              ...
              <div class="py-2">
                ...
                <p>
                  ...
                  agreements if required to demonstrate our due care.
                </p>
              </div>
            </div>
            <div class="row">
              ...
              <div class="py-2">
                ...
                <p>
                  ...
                  Your goals are ours, and we are happy to help you.
                </p>
              </div>
            </div>
          </div>
    ...
    <section class="services" id="services">
      <div class="container">
        <div class="section-title" data-aos="fade-up">
          <span></span>
          <h2>Our Services</h2>
          <p>Armed with high-rated 150+ Translators from many countries around the world, Lexicology Translation can
            translate text into and from over 150+ languages, guaranteeing client satisfaction.</p>
        </div>
        <div class="row">
      ...
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          ...
          <p class="mt-3 text-center">
            Lexicology translation bureau works in cooperation with many translation institute from across the world in
            order to provide certified Translation and Training Services for our customers in the Kingdom of Saudi
            Arabia and around the world.</p>
        </div>
        ...
        <div class="row" data-aos="fade-left">
          ...
          <div class="col-md-6 mt-sm-5">
            ...
            <p>
              ...
              Offering more than two decades of experienced perfection for Professional Services and Intellectual
              Property serves their high-profile clients through 8- translation offices all over the world. They are a
              leader in the professional services sector in the Arab World, and a well-known group, thanks to the
              widespread network of branches and representative offices.
            </p>
    ...
    <section style="background-color:#F5F4F9">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-2 pr-3" style="margin-left:-30px !important; ">
                <img src="assets/img/lexicologyTranslationLogo.png" alt="lexicology TranslationLogo"
                  style="max-width:110%; height:40px;" />
              </div>
              <div class="col-md-10">
