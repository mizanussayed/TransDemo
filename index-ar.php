...
<head>
  ...
  <link rel="canonical" href="https://lexicologytranslation.com/index-ar" />
        ...
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            ...
            <div class="text-center text-lg-start">
              <a href="contact-ar" class="btn-get-started">احصل على عرض أسعار</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="testimonials" id="testimonials">
      <div class="container">
        <div class="section-title" data-aos="fade-up">
          ...
          <p>نحن نحب الشراكة / العملاء وتنمية الأعمال التجارية الطموحة والناجحة لأننا ملتزمون بتقديم مستوى ثابت من الجودة في جميع خدماتنا. نحن نهتم بنجاحكم. أهدافكم هي أهدافنا ، ويسعدنا مساعدتكم في تحقيق أهدافكم.</P>
        </div>
        <div class="testimonials-slider swiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/Aramco.png" class="testimonial-img" alt="Aramco" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/Sabic.png " class="testimonial-img" alt="Sabic" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/EUEA.png" class="testimonial-img" alt="EUEA" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/EY.png" class="testimonial-img" alt="EY" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/GEA.png" class="testimonial-img" alt="GEA" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/king-faisal-hospital.png" class="testimonial-img"
                  alt="king faisal hospital " />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/MAAden.png" class="testimonial-img" alt="MAAden" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/Ministry-of-commerce-and-IT.png " class="testimonial-img"
                  alt="Ministry of commerce and IT" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/Ministry-of-finance.png" class="testimonial-img"
                  alt="Ministry of finance" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/Ministry-of-Health.png" class="testimonial-img"
                  alt=" Ministry of Health" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/Ministry-of-HR.png" class="testimonial-img" alt="Ministry of HR" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/Ministry-of-Tourism.png " class="testimonial-img"
                  alt="Ministry of Tourism" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/MISK.png" class="testimonial-img" alt="MISK" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/SAIP.png" class="testimonial-img" alt="SAIP" />
              </div>
            </div>

            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/SBA.png" class="testimonial-img" alt=" SBA " />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/SNB.png" class="testimonial-img" alt="SNB" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/solutions-by-stc.png" class="testimonial-img" alt="solutions by stc" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/tamimi.png " class="testimonial-img" alt="tamimi" />
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="./assets/img/english/WHO-Arabic.png" class="testimonial-img" alt="WHO Arabic" />
              </div>
            </div>
            ...
            <div class="row">
              <div class="py-2">
                <h4> <img src="./assets/img/check-mark-1.svg" alt="lexicology Translation" />
                  &nbsp; &nbsp; الجودة الأفضل والسعر الأقل</h4>
                <p>
                  حن مرنون للغاية ونفخر بالعمل مع عملاء يقدرون العمل عالي الجودة في بيئة من الاحترام المتبادل. هكذا نفكر
                  في تقديم خدماتنا في الترجمة حيث قمنا بتطوير هذا المفهوم منذ تأسيس مكتبنا وقد عملنا على إنشاء سير عمل
                  ترجمة عالي الجودة والاتساق.
                </p>
              </div>
              <div class="py-2">
                <h4> <img src="./assets/img/check-mark-1.svg" alt="lexicology Translation" />
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <p class="description">تتم ترجمة النصوص الأكاديمية من قبل مترجمين ذوي خبرة ويمتلكون الذخيرة المعجمية
                الكافية.
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              ...
              <p class="description"> نقدم ترجمة لأي نوع من المستندات على سبيل المثال الاتصالات التجارية والمواقع
                الإلكترونية والإعلانات والوثائق المحاسبية والطبية وفي مجال التسويق، وكافة المجالات.</p>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              ...
              <p class="description">يتم تقييم احتياجاتك التجارية الدولية في هذه الفئة .نحن نقدم أفضل خدمة لتمكينك من
                دخول سوق جديد والحفاظ على علاقاتك الدولية المتاحة بسلاسة وحرية.</p>
            </div>
          </div>
        ...
        <div class="row pt-5">
          <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              ...
              <p class="description">يتطلب هذا النوع من الترجمة خبرة في موضوع الترجمة الفنية والأدبية ، ولدينا مترجمون
                ذوي خبرة في هذا المجال.</p>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              ...
              <p class="description">تغطي خدمات الترجمة القانونية لدينا جميع أنواع العقود القانونية، والنشرات القانونية،
                وكتيبات الحسابات القانونية، وما إلى ذلك.</p>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              ...
              <p class="description">نحن نطلب أن يكون جميع المترجمين الطبيين ومحرري الترجمة على درجة عالية من التعليم ،
                وأن يتلقوا تدريباً مناسباً ، ولديهم خبرة عمل فعلية في مجالات الطب.</p>
            </div>
          </div>
        ...
        <div class="row mt-3 pt-4">
          <div class="col-md-12 text-center">
            <a href="services-ar" class="btn btn-outline-primary">عرض جميع الخدمات</a>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-left">
          <div class="col-md-6">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="100">
              <a href="assets/img/gallery/gallery-1.jpg" class="gallery-lightbox">
                <img src="assets/img/gallery/gallery-1.jpg" aalt="lexicology Translation" class="img-fluid">
              </a>
            </div>
          </div>
          <div class="col-md-6 mt-sm-5">
            ...
            <p>
              من المعروف أن العديد من مكاتب الترجمة ومنظمات الخدمات المهنية والملكية الفكرية تخدم عملائها البارزين من
              خلال مكاتب الترجمة التابعة لها في جميع أنحاء العالم. نسعى من جانبنا لنصبح رائدين في قطاع الخدمات المهنية
              في العالم العربي بفضل شبكة واسعة من الفروع والمكاتب </p>
          ...
          <div class="col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="100">
              <a href="assets/img/gallery/lexicologyTranslation.png" class="gallery-lightbox">
                <img src="assets/img/gallery/lexicologyTranslation.png" alt="lexicology Translation Gallary"
                  class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="150">
              <a href="assets/img/gallery/lexicologyTranslation1.jpg" class="gallery-lightbox">
                <img src="assets/img/gallery/lexicologyTranslation1.jpg" alt="lexicology Translation Gallary"
                  class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="200">
              <a href="assets/img/gallery/lexicologyTranslation2.jpg" class="gallery-lightbox">
                <img src="assets/img/gallery/lexicologyTranslation2.jpg" alt="lexicology Translation Gallary"
                  class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="250">
              <a href="assets/img/gallery/lexicologyTranslation3.jpg" class="gallery-lightbox">
                <img src="assets/img/gallery/lexicologyTranslation3.jpg" alt="lexicology Translation Gallary"
                  class="img-fluid">
              </a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="300">
              <a href="assets/img/gallery/lexicologyTranslation4.jpg" class="gallery-lightbox">
                <img src="assets/img/gallery/lexicologyTranslation4.jpg" alt="lexicology Translation Gallary"
                  class="img-fluid">
              </a>
            </div>
          </div>
          <div class=" col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="350">
              <a href="assets/img/gallery/lexicologyTranslation5.jpg" class="gallery-lightbox">
                <img src="assets/img/gallery/lexicologyTranslation5.jpg" alt="lexicology Translation Gallary"
                  class="img-fluid">
              </a>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-2">
                <br /> &nbsp; &nbsp;
                <img src="assets/img/lexicologyTranslationLogo.png" alt="lexicology Translation Logo" width="100" />
              </div>
              <div class="col-md-10">
                <h2 class="bolder">هل تحتاج مساعدة؟</h2>
                <p>
                  نحن هنا لمساعدتك في الحصول على عرض أسعار مناسب للمستندات، وترجمة مواقع الويب وملفات البي دي اف وترجمة
                  البرامج والمشاريع الأخرى المتعلقة بالترجمة.
                </p>
              </div>
            </div>
          </div>
