<footer id="footer">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-infod">
                        <img src="assets/img/lexicologyTranslationFooterLogo.png" alt="lexicology translation logo"
                            width="90" />
                        <h3>مكتب علوم المعاجم للترجمة </h3>
                        <p class="pb-3">يُقدمّ مكتب علوم المعاجم للترجمة خدمات ترجمة احترافية ودقيقة وبأسعارٍ معقولة
                            للعملاء الذين يسعون للحصول على ترجمات مضمونة عالية الجودة، وذلك بفضل فريقه الذي يضم أكثر من
                            150+ مترجمًا متميزًا من جميع أنحاء العالم مما يساعده في تقديم ترجماتٍ عالية الجودة وفقًا
                            لمعايير الشركة.
                        </p>
                        <div class="social-links mt-3">
                            <a href="#" class="twitter"><i class="bi bi-twitter"></i></a>
                            <a href="https://www.facebook.com/profile.php?id=100091641174711" class="facebook"><i
                ...
                <div class="col-md-3 footer-links">
                    <h4>ارتباط هام</h4>
                    <ul>
                        <li><i class="bi bi-chevron-left"></i> <a href="index-ar">الرئيسية</a></li>
                        <li><i class="bi bi-chevron-left"></i> <a href="services-ar">خدماتنا</a></li>
                        <li><i class="bi bi-chevron-left"></i> <a href="contact-ar">اتصل بنا</a></li>
                    </ul>
                </div>
                <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="col-1 text-center">
                            <p style="font-size:1.4rem"> <i class="bi bi-geo-alt-fill"></i></p>
                        </div>
                        <div class="col-11">
                            <h4>العنوان</h4>
                            <p>
    ...
    <div class="container" id="bottom-footer">
        ...
        <div class="copyright"> &copy;
            <script>document.write(new Date().getFullYear())</script> مكتب علوم المعاجم للترجمة. جميع الحقوق
            محفوظة</strong>
        </div>
        <div class="credits">
            صمم بواسطة <a href="https://fb.com/mizanussayed">&nbsp; &nbsp;M</a>
        </div>
    </div>
</footer>
<a class="whatsapp active d-flex align-items-center justify-content-center"
    href="https://api.whatsapp.com/send/?phone=9660554237826&text&type=phone_number&app_absent=0" target="_blank">
