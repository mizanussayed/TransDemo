...
<div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
    <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
      ...
      <p class="description"> 
      Proficient in translating documents produced by technical writers (owner's manuals, user guides, etc.) </p>
    </div>
  </div>
  ...
  <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
    <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
      ...
      <p class="description">Translating your website is one of the most cost effective ways to reach the international markets.</p>
    </div>
  </div>
  ...
  <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
    <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
      ...
      <p class="description">We can provide a translation in an Excel spreadsheet so that you can localize the content in house. We can also handle the job through an external webmaster or DTP (desktop publishing) professional.</p>
    </div>
  </div>
  ...
  <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
    <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
      ...
      <p class="description">We can offer your company custom-made virtual translation office, which acts as your in-house translator or translation department. Your company will benefit from a dedicated virtual translation office while saving on: Salaries & allowances, office space, Commuting, and Consumables.</p>
    </div>
  </div>
