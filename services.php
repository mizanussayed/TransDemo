...
<body>
  ...
  <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/service.jpg');">
    <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
      ...
      <h2>CERTIFIED HUMAN TRANSLATIONS
        TO HELP YOU GROW</h2>
      <ol>
      ...
      <div class="row">
        ...
        <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
          <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
            <div class="icon"><img src="./assets/img/services/Business-Translation.png" alt="lexicology Translation" />
            </div>
            ...
            <p class="description">
              ...
              you to access new market and maintain your available international relationships smoothly and freely.</p>
          </div>
        </div>
      ...
      <div class="row pt-5">
        ...
        <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
          <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
            ...
            <h4 class="title"><a href="#">Technical & Engineering Translation </a></h4>
            <p class="description">
              Proficient in translating documents produced by technical writers (owner's manuals, user guides, etc.)
            </p>
          </div>
        </div>
        ...
        <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
          <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
            ...
            <h4 class="title"><a href="#">Website Translation </a></h4>
            <p class="description">Translating your website is one of the most cost effective ways to reach the
        ...
        <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
          <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
            ...
            <h4 class="title"><a href="#">Documents Containing Graphics</a></h4>
            <p class="description">We can provide a translation in an Excel spreadsheet so that you can localize the
              content in house. We can also handle the job through an external webmaster or DTP (desktop publishing)
              professional.</p>
          </div>
        </div>
        ...
        <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
          <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
            ...
            <h4 class="title"><a href="#">In House Translation </a></h4>
            <p class="description">We can offer your company custom-made virtual translation office, which acts as your
              in-house translator or translation department. Your company will benefit from a dedicated virtual
              translation office while saving on: Salaries & allowances, office space, Commuting, and Consumables.</p>
          </div>
        </div>
  ...
  <section>
    <div class="container p-3 mb-5">
      <div class="row text-center">
        ...
        <p>
          We are here to assist you move forward by leveraging our rich experience and team of experts.
        </P>
        <a href="contact" class="btn btn-outline-secondary col-2 mx-auto">Contact Us</a>
      </div>
    </div>
    </scction>
